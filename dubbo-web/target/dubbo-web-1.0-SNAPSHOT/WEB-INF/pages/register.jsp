...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/jquery/jquery.ajaxfileupload.js"></script>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <%--&lt;%&ndash;<h4 class="lighter">New Item Wizard</h4>&ndash;%&gt;--%>
                                    ...
                                    <%--<div class="widget-main">--%>
                                        ...
                                        <div class="step-content row-fluid position-relative" id="step-container">
                                            <div class="step-pane active" id="step1">
                                                <h3 class="lighter block green">基本信息填写</h3>
                                                ...
                                                <form class="form-horizontal" id="validation-form" method="get">
                                                    ...
                                                    <%--<div id="dropzone" class="form-group">--%>
                                                        <%--<form action="//dummy.html" class="dropzone">--%>
                                                            <%--<div class="fallback"  style="padding-left:25%" >--%>
                                                ...
                                                <form id="uploadForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/file/upload.action">
